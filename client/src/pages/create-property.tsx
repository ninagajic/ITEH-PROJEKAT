...
const CreateProperty = () => {
  ...
  //U handleImageChange se definise funkcija za promenu slike za hotel. 
...
//U onFinishHandler se definise funkcija koja se poziva kada se formular za kreiranje hotela zavrsi. 
//Prvo se proverava da li je korisnik dodao sliku za hotel. Ako nije, prikazuje se upozorenje
  const onFinishHandler = async (data:FieldValues) => {
    if (!propertyImage.name) return alert('Please upload a hotel image');
    // u suprotnom poziva se onFinish funkcija i salju se podaci formulara, URL slike za hotel i email korisnika.
